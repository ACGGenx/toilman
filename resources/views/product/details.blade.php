    ...
    <div class="container-fluid py-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <!-- Main Image -->
                <div class="main-image-wrapper position-relative" style="width: 80%;height: 320px;">
            ...
            <div class="col-md-6">
                <div class="product-info ps-md-4">
                    <h4>Product Name :</h4>
                    <div class="product-title"><span>{{ $product->name }}</span></div>
                    @if($product->category)
        ...
        <script>
            ...
            @php
            $images = $product->images ? $product->images->pluck('image_path') : collect([]);
            @endphp
